...
def _classes() -> dict[str, type]:
    from domain.quantitative import analysis, analysis_execution, analysis_plan, dataset, finding, finding_lineage, insight, insight_lineage, measurement_reconciliation, quality, questionnaire_authority, report, research_design_authority, weighting, workflow
    result = {}
    for module in (analysis, analysis_execution, analysis_plan, dataset, finding, finding_lineage, insight, insight_lineage, measurement_reconciliation, quality, questionnaire_authority, report, research_design_authority, weighting, workflow):
