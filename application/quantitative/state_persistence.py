...
def _classes() -> dict[str, type]:
    from domain.quantitative import analysis, analysis_execution, analysis_plan, dataset, finding, finding_lineage, insight, insight_lineage, measurement_reconciliation, objective_coverage, quality, questionnaire_authority, report, report_lineage, research_design_authority, research_question_coverage, weighting, workflow
    result = {}
    for module in (analysis, analysis_execution, analysis_plan, dataset, finding, finding_lineage, insight, insight_lineage, measurement_reconciliation, objective_coverage, quality, questionnaire_authority, report, report_lineage, research_design_authority, research_question_coverage, weighting, workflow):
