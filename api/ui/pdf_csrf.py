...
def token(container, owner_id: str, project_id: str, method: str, source_id: str) -> str:
    message = "\x1f".join(("pdf-generation-v1", owner_id, project_id, method, source_id))
...
def valid(container, owner_id: str, project_id: str, method: str,
          source_id: str, candidate: str) -> bool:
    return hmac.compare_digest(token(container, owner_id, project_id, method, source_id),
                               candidate)
