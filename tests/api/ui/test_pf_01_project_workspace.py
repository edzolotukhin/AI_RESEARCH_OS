...
class Pf01ProjectWorkspaceTests(ApiTestCase):
    ...
    def test_empty_list_and_explicit_project_creation(self):
        self.assertIn("No projects yet", self.client.get("/ui/projects").text)
        ...
        self.assertIn("No research brief yet", page.text)
        self.assertEqual(page.text.count("Not started"), 2)
    ...
    def test_project_bound_quantitative_has_three_distinct_ids_and_return_link(self):
        ...
        self.assertIn("Open Quantitative Research", workspace)
